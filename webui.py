...
def check_pretrained_is_exist(version):
    pretrained_model_list = (
        ...
        "GPT_SoVITS/pretrained_models//wavlm-plus",
    )
    _ = ""
                    ...
                    with gr.Row():
                        ...
                        with gr.Row():
                            bert_pretrained_dir = gr.Textbox(
                                ...
                                # value="GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large", USER-bge-m3
                                value="GPT_SoVITS/pretrained_models/USER-bge-m3", 
                                interactive=False,
                                lines=2,
                            )
                        with gr.Row():
                    ...
                    with gr.Row():
                        ...
                        with gr.Row():
                            cnhubert_base_dir = gr.Textbox(
                                ...
                                # value="GPT_SoVITS/pretrained_models/chinese-hubert-base",/wavlm-plus"
                                value="GPT_SoVITS/pretrained_models/wavlm-plus",
                                interactive=False,
                                lines=2,
                            )
                        with gr.Row():
