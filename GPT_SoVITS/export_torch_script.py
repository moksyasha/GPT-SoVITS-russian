...
# bert_path = os.environ.get("bert_path", "GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large")USER-bge-m3
bert_path = os.environ.get("bert_path", "GPT_SoVITS/pretrained_models/USER-bge-m3")
# cnhubert_base_path = "GPT_SoVITS/pretrained_models/chinese-hubert-base"value="GPT_SoVITS/pretrained_models/chinese-hubert-base",/wavlm-plus"
cnhubert_base_path = "GPT_SoVITS/pretrained_models/wavlm-plus"
